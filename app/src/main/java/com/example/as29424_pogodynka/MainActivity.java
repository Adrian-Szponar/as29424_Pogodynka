package com.example.as29424_pogodynka;
...
public class MainActivity extends AppCompatActivity {
    ...
    String CITY;
    String API = "a09d5ffeb5d2ca90d78fa0423eb259a0";
    //"98ed13acba37b8f64a391fd3a3748865";
    ImageView search;
    EditText etCity;
    ...
    class weatherTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                String updatedAtText = "Ostatnia Aktualizacja: " + new SimpleDateFormat("dd/MM/yyyy hh:mm a", Locale.ENGLISH).format(new Date(updatedAt * 1000));
